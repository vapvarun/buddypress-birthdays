...
$bbd_ecosystem = array(
	array(
		'name' => __( 'BuddyNext', 'buddypress-birthdays' ),
		'logo' => 'buddynext.svg',
	...
	array(
		'name' => __( 'Jetonomy', 'buddypress-birthdays' ),
		'logo' => 'jetonomy.svg',
	...
	array(
		'name' => __( 'Mediaverse', 'buddypress-birthdays' ),
		'logo' => 'mediaverse.svg',
	...
	array(
		'name' => __( 'Listora', 'buddypress-birthdays' ),
		'logo' => 'listora.svg',
	...
	array(
		'name' => __( 'Learnomy', 'buddypress-birthdays' ),
		'logo' => 'learnomy.svg',
...
<div class="bbd-card">
	<div class="bbd-card__head">
		...
		<p class="bbd-card__desc"><?php esc_html_e( 'Birthday reminders keep members coming back. These free Wbcom Designs plugins give your community more reasons to stay: the network itself, forums, media, directories, and courses.', 'buddypress-birthdays' ); ?></p>
	</div>
